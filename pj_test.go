...
`,
			expectedResult: &proj.FullPJInfo{
				...
				CrsMatches: []proj.IdentifyMatchInfo{{proj.SRID{"EPSG", "32633"}, "WGS 84 / UTM zone 33N", 100}},
			},
		},
		"vertical_crs": {
...
`,
			expectedResult: &proj.FullPJInfo{
				...
				CrsMatches: []proj.IdentifyMatchInfo{{proj.SRID{"EPSG", "9707"}, "WGS 84 + EGM96 height", 100}},
			},
		},
...
`,
		...
		"crs_proj4": {
			...
			expectedResult: &proj.FullPJInfo{
				...
				Type:  proj.PJ_TYPE_GEOGRAPHIC_2D_CRS,
				CrsMatches: []proj.IdentifyMatchInfo{
					{proj.SRID{"OGC", "CRS84"}, "WGS 84 (CRS84)", 70},
					{proj.SRID{"IGNF", "WGS84GDD"}, "WGS84 geographiques (dd)", 70},
					{proj.SRID{"IGNF", "WGS84G"}, "WGS84 geographiques (dms)", 70},
					{proj.SRID{"EPSG", "4326"}, "WGS 84", 70},
				},
			},
		},
		"fantasy_crs_wkt": {
